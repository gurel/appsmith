...
public class GrpcPluginTest {
    ...
    @Container
    public static GenericContainer grpcContainer = new GenericContainer(
                    CompletableFuture.completedFuture("gerritforge/gripmock"))
            .withClasspathResourceMapping("Chat.proto", "/proto/Chat.proto", BindMode.READ_ONLY)
            .withClasspathResourceMapping("/mystubs", "/stub", BindMode.READ_ONLY)
    ...
    public void testExecute() {
        ...
        Mono<ActionExecutionResult> actionExecutionResultMono = pluginExecutor
                .datasourceCreate(dc)
                .flatMap((connection) -> pluginExecutor.executeParameterized(
                        connection, new ExecuteActionDTO(), dc, actionConfiguration));
